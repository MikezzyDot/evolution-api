...
export class SendMessageController {
	...
	public async sendCustomMetaMessage({ instanceName }: InstanceDto, data: SendCustomMetaDto) {
		logger.verbose('requested sendList from ' + instanceName + ' instance');
		return await this.waMonitor.waInstances[instanceName].customMetaMessage(data);
	}
