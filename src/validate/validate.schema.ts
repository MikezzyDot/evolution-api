...
export const customMetaMessageSchema: JSONSchema7 = {
	$id: v4(),
	type: 'object',
	properties: {
		number: { ...numberDefinition },
		...
		metaObjectType: { type: 'string' },
		metaObject: { type: 'object' },
		metaCustom: { type: 'string' },
		formattedMessage: { type: 'string' },
	},
	required: ['number', 'metaType', 'metaObjectType', 'metaObject', 'metaCustom', 'formattedMessage'],
};
